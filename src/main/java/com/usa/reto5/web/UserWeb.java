...
import com.usa.reto5.Services.UserService;
...
public class UserWeb {
    ...
    @GetMapping("/birthday/{brith}")
    public List<User> getBrith(@PathVariable("brith") String brith) {
        return service.findByMonthBirthtDay(brith);
    }
